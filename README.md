# WP HTMX Router
[![Latest Stable Version](https://poser.pugx.org/webshr/wp-htmx-router/v/stable)](https://packagist.org/packages/webshr/wp-htmx-router)
![CI](https://github.com/webshr/wp-htmx-router/actions/workflows/ci.yml/badge.svg?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/webshr/wp-htmx-router/badge.svg)](https://coveralls.io/github/webshr/wp-htmx-router)
...
```
composer require webshr/wp-htmx-router
```
...
You can also apply Middleware on a Controller class too. In order to do this your Controller must extend the `Webshr\WPHTMX\Router\Controller` base class.
