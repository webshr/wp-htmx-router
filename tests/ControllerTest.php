...
use Webshr\WPHTMX\Router\Test\Controllers\MiddlewareProvidingController;
...
class ControllerTest extends TestCase
{
    ...
    public function can_add_single_middleware_via_controller ()
    {
        ...
        $router->get(
            '/test/123',
            'Webshr\WPHTMX\Router\Test\Controllers\MiddlewareProvidingController@returnOne',
        );
    ...
    protected function assertMiddlewareIsAppliedToMethods ( $router, $middlewareAppliedToMethods )
    {
        ...
        foreach ( $middlewareAppliedToMethods as $method => $applied ) {
            $router->get(
                '/test/' . $method,
                'Webshr\WPHTMX\Router\Test\Controllers\MiddlewareProvidingController@' . $method
            );
        }
