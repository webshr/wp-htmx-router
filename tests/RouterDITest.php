...
use Webshr\WPHTMX\Router\Test\Controllers\TestController;
use Webshr\WPHTMX\Router\Test\Requests\TestRequest;
...
class RouterDITest extends TestCase
{
    ...
    public function route_params_are_injected_into_controller_class ()
    {
        ...
        $router->get( '/posts/{postId}/comments/{commentId}', 'Webshr\WPHTMX\Router\Test\Controllers\TestController@expectsInjectedParams' );
    ...
    public function typehints_are_injected_into_controller_class ()
    {
        ...
        $router->get( '/test/route', 'Webshr\WPHTMX\Router\Test\Controllers\TestController@typeHintTestService' );
    ...
    public function typehints_are_injected_into_controller_class_with_params ()
    {
        ...
        $router->get( '/posts/{postId}/comments/{commentId}', 'Webshr\WPHTMX\Router\Test\Controllers\TestController@typeHintTestServiceWithParams' );
    ...
    public function constructor_params_are_injected_into_controller_class ()
    {
        ...
        $router->get( '/test/url', 'Webshr\WPHTMX\Router\Test\Controllers\TestConstructorParamController@returnTestServiceValue' );
