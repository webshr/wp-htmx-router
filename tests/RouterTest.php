...
use Webshr\WPHTMX\Router\Exceptions\NamedRouteNotFoundException;
use Webshr\WPHTMX\Router\Exceptions\RouteClassStringControllerNotFoundException;
use Webshr\WPHTMX\Router\Exceptions\RouteClassStringMethodNotFoundException;
use Webshr\WPHTMX\Router\Exceptions\RouteClassStringParseException;
use Webshr\WPHTMX\Router\Exceptions\RouteParamFailedConstraintException;
use Webshr\WPHTMX\Router\Exceptions\TooLateToAddNewRouteException;
use Webshr\WPHTMX\Router\Route;
use Webshr\WPHTMX\Router\RouteGroup;
use Webshr\WPHTMX\Router\RouteParams;
...
class RouterTest extends TestCase
{
    ...
    public function match_works_with_a_class_and_method_string()
    {
        ...
        $route = $router->get('/test/123', 'Webshr\WPHTMX\Router\Test\Controllers\TestController@returnHelloWorld');
        $response = $router->match($request);
    ...
    public function match_throws_exception_when_class_and_string_method_contains_an_unfound_class()
    {
        ...
        $route = $router->get('/test/123', 'Webshr\WPHTMX\Router\Test\Controllers\UndefinedController@returnHelloWorld');
    }
    ...
    public function match_throws_exception_when_class_and_string_method_contains_an_unfound_method()
    {
        ...
        $route = $router->get('/test/123', 'Webshr\WPHTMX\Router\Test\Controllers\TestController@undefinedMethod');
    }
